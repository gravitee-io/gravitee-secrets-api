...
class SecretSpecTest {
    ...
    public static Stream<Arguments> okSpecs() {
        return Stream.of(
            ...
            arguments("generated dyn key", null, null, "/foo/bar", null, DYNAMIC_KEY, GENERATED, "dev"),
            arguments("made uri static key", "123456", null, "/foo/bar", "baz", STATIC_KEY, MADE, "dev"),
            arguments("made uri dyn key", "123456", null, "/foo/bar", null, DYNAMIC_KEY, MADE, "dev"),
            arguments("named uri static key", "123456", null, "/foo/bar", "baz", STATIC_KEY, MADE, "dev"),
            arguments("named uri dyn key", "123456", null, "/foo/bar", null, DYNAMIC_KEY, MADE, "dev"),
    ...
    void should_be_able_to_create_spec(
        ...
        Assertions
            .assertThatCode(() -> new SecretSpec(id, name, uri, key, dynKey, generated, null, null, null, envId))
    ...
    public static Stream<Arguments> nokSpecs() {
        return Stream.of(
            ...
            arguments("with static and dyn key", "123", null, "/foo/bar", "baz", DYNAMIC_KEY, GENERATED, "dev"),
